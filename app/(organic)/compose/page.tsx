...
function ComposeContent() {
  ...
  // le composant partagé avec /series : une seule implémentation de l'UI de
  // conformité, donc pas de dérive possible entre les deux écrans.
  const tiktokSelected = selectedPlatforms.includes("tiktok");
  const tiktokState = useTikTokOptions({ companyId: company.id, active: tiktokSelected });
  const tiktokReady = tiktokState.ready;
  const tiktokOptions = tiktokState.options;
        ...
        body: JSON.stringify({
          ...
          media: upload
            ? {
                ...
                ...(platform === "tiktok" && tiktokOptions ? { tiktok: tiktokOptions } : {}),
    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_360px]">
        ...
        <div className="card space-y-7 p-6">
          ...
          {tiktokSelected && (
            <TikTokOptionsPanel state={tiktokState} isImage={upload?.kind === "image"} />
          )}
